...
import { FaCar, FaCarBattery, FaRecycle, FaTint, FaTools, FaPhoneAlt } from 'react-icons/fa';
  ...
  const services = [
      {
        ...
        image: 'https://images.unsplash.com/photo-1619641805634-b867f535071c?q=80',
        description: 'Wide range of new batteries for all types of vehicles and applications.',
        features: ['Premium Brands', 'Warranty Coverage', 'Expert Guidance', 'Best Prices'],
      },
      {
        id: 2,
        title: 'Battery Charging',
        icon: <FaCarBattery className="text-4xl text-red-500" />,
        image: 'https://images.unsplash.com/photo-1593941707882-a5bba14938c7?q=80',
        description: 'Professional battery charging services with latest equipment.',
        features: ['Fast Charging', 'Deep Cycle Charging', 'Battery Testing', '24/7 Service'],
      },
      {
        id: 3,
        title: 'Battery Exchange',
        icon: <FaRecycle className="text-4xl text-red-500" />,
        image: 'https://hips.hearstapps.com/hmg-prod/images/how-we-tested-65677d1419c0d.jpeg',
        description: 'Exchange your old battery and get great value on new purchases.',
        features: ['Fair Evaluation', 'Instant Exchange', 'Environmental Friendly', 'Best Exchange Rates'],
      },
      {
        id: 4,
        ...
        features: ['High Purity', 'Bulk Supply', 'Home Delivery', 'Regular Supply'],
      },
      {
        id: 5,
        ...
        image: 'https://hips.hearstapps.com/hmg-prod/images/how-we-tested-65677d1419c0d.jpeg',
        description: 'Complete automotive electrical system diagnostics and repair.',
        features: ['Alternator Service', 'Starter Repair', 'Wiring Solutions', 'System Diagnosis'],
      },
      {
        id: 6,
        ...
        features: ['Quick Response', 'Mobile Service', 'Jump Start', 'Roadside Assistance'],
      },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute bottom-4 left-4 flex items-center space-x-2 bg-white text-black p-2 px-5 rounded-2xl">
                  {React.cloneElement(service.icon, { className: "text-3xl text-red-500" })}
              ...
              <div className="p-6 bg-gray-800/80 border-t border-gray-700">
                ...
                <button onClick={handleClick} className="w-full flex items-center justify-center px-6 py-3 bg-gradient-to-r from-red-600 to-red-700 rounded-xl text-white font-medium hover:from-red-700 hover:to-red-800 transition-all duration-300 transform group-hover:scale-105">
        ...
        <div className="mt-20 text-center bg-gray-800/50 backdrop-blur-sm rounded-2xl p-10 border border-gray-700">
          <div className="flex flex-col items-center">
            ...
            <h3 className="text-3xl font-bold text-white">Need Emergency Service?</h3>
            <p className="mt-4 text-xl text-gray-300">
